package views.main {
	...
	public class MapPage extends View {
		...
		private function showLegendLabel(label:TextLabel, labelText:String, delay:Number):void {
			label.alpha = 0;
			label.x = -Grid.SPAN_2;
		...
		private function addLabel(posX:int, posY:int, text:String, delay:Number):void {
			var label:TextLabel = new TextLabel();
			label.x = posX;
			label.y = posY;
			label.shapeWidth = Grid.SPAN_2;
		...
		private function addLine(startX:int, startY:int, endX:int, endY:int, delay:Number):void {
