package views.overlays {
	...
	public class HelpOverlay extends PageOverlay {
		...
		public function HelpOverlay(background:* = 0xffffff, w:Number = 870,h:Number = 700) {
			...
			if (Main.LANGUAGE == 'DE') {
				infoText.setText('Wenn Du Hilfe an Deinem aktuellen Ort brauchst drücke bitte auf "Hilfe rufen".\n' +
								 'Wir werden anschließend einen freundlichen Helfer zu Dir schicken!\n\n\n');
			} else {
			...
			showSubmitButton((Main.LANGUAGE == 'DE' ? 'Hilfe rufen' : 'Call help'), function() {
				...
				if (Main.LANGUAGE == 'DE') {
					...
					infoText.setText('Bitte warte an dem Terminal und schließe dieses Fenster erst,\n' +
									 'wenn unsere Unterstützung Dich erreicht hat.\n' +
									 'Solltest Du keine Hilfe mehr benötigen, drücke einfach auf "Abbrechen".\n\n');
				} else {
